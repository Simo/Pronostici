...
woff = path + "/webfonts/woff/style_189178.woff";
if (http) {
...
//test for eot
eot = path + "/webfonts/eot/style_189178.eot";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for svg
svg = path + "/webfonts/svg/style_189178.svg";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
...
//test for css
css = path + "/webfonts/datacss/MyFontsWebfontsOrderM2878907.css";
if (http) {
	xmlhttp=new XMLHttpRequest();
}
else {
